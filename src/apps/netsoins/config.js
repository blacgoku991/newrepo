    ...
    sections: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            help: 'Demandé par Adef Résidences (CR du 4 août 2026). Non encore saisi par le robot : à reporter manuellement dans NetSoins tant que le champ correspondant n’a pas été repéré sur l’instance réelle.',
          },
          {
            name: 'email',
          ...
          },
          {
            ...
            help: 'Uniquement pour les professionnels de santé. Vérification nom/prénom/RPPS à faire manuellement pour l’instant (contrôle automatique non encore en place — cf. CR du 4 août 2026).',
          },
          {
            name: 'mssante',
            ...
            type: 'email',
            required: false,
            placeholder: 'paul.martin@professionnels.mssante.fr',
            help: 'Pour les professionnels concernés uniquement. Demandé par Adef Résidences (CR du 4 août 2026). Non encore saisi par le robot.',
          },
        ],
      },
      {
