 ...
 *   --grace    <jours>       Tolérance après la date de fin. DÉFAUT : 0 — la
 *                            licence s'arrête le jour dit. À n'utiliser que
 *                            pour un geste commercial explicite.
...
const grace = Number(arg('grace', '0'));
const note = arg('note');
...
console.log(`  Validité      : du ${debut} au ${fin}${grace ? ` (tolérance ${grace} j)` : ' — aucune tolérance'}`);
